...
const BookingDetails = () => {
  return (
    <>
      <div
        className="flex items-end justify-between flex-wrap gap-y-[20px] px-6 py-7 mt-5 rounded-[12px] max-[767px]:flex-col max-[767px]:items-start max-[767px]:pl-5 max-[767px]:py-4 max-[767px]:pr-3.5 max-[767px]:gap-y-[0px]"
          ...
          <div className="flex items-center justify-between mb-1 flex-wrap gap-y-[5px]">
            ...
            <div className="start_now px-3.5 pr-0 flex items-center justify-between gap-2 relative max-[767px]:pl-0">
              ...
              <div className="book_status">
                <div className="absolute right-0 -top-[23px] bg-[#009efb] px-2 py-1 rounded-lg max-[767px]:relative max-[767px]:top-0">
      ...
      <div
        className="pl-8.5 pr-6.5 py-6.5 rounded-[12px] border border-[#e2e8f0] my-4 max-[767px]:pl-5 max-[767px]:pr-5 max-[767px]:pb-3.5"
        ...
        <div className="appoinment_details_section flex items-start justify-between flex-wrap gap-y-[20px] max-[767px]:flex-col max-[767px]:gap-y-[0px]">
          ...
          <div className="booking_icon flex-row basis-43 max-[767px]:basis-auto">
            <div className="flex items-center justify-start gap-2 pb-2.5">
              ...
              <p className="capitalize font-bold text-[#009efb] text-sm">
                booked
              </p>
            </div>
            <div className="flex items-center justify-start gap-2 pb-2.5">
