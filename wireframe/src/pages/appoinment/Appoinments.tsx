...
const Appoinments = () => {
  ...
  return (
    <div className="appoinment_section">
      <div className="flex justify-between border-b-[1px] border-[#e2e8f0] pb-3 max-[767px]:pb-0 max-[767px]:flex-col max-[767px]:border-b-[0px] gap-y-[20px] max-[576px]:justify-center items-center">
        <div className="appoinment_heading">
          <h3 className="text-[24px] leading-none font-semibold text-[#272b41] capitalize max-[767px]:text-[20px]">
